...
const Footer = () => {
    ...
    const {  user } = useAuth();
    return (
        <div className="mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4 py-12 bg-gray-100 dark:bg-blue-950 mt-2">
            <div className="flex flex-col items-center justify-center">
                <div className='bold'>
                    <h1 className="font-extrabold text-black dark:text-white text-3xl">Marry-Me</h1>
                    <hr  className='h-1 bg-black dark:bg-white w-[50%] my-2'/>
                </div>
                <div className="flex flex-wrap sm:gap-10 gap-8 items-center justify-center mt-8">
                    <p className="hover:text-gray-500 text-base cursor-pointer leading-4 dark:text-white"><a href='/about'>About</a></p>
                    <p className="hover:text-gray-500 text-base cursor-pointer leading-4 dark:text-white"> <a href='/contact'>Contact us</a>  </p>
                    <p className="hover:text-gray-500 text-base cursor-pointer leading-4 dark:text-white"><a  href={user? "/feature":"/signup"}>Register</a></p>
                 
                </div>
                <div className="flex items-center gap-x-8 mt-6">
                    <div className="cursor-pointer">
                        <svg className="fill-current dark:text-white hover:text-gray-500" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="cursor-pointer">
                        <svg className="fill-current dark:text-white  hover:text-gray-500" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="cursor-pointer">
                        <svg className="fill-current dark:text-white hover:text-gray-500" width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div className="flex items-center mt-6">
                    <p className=" leading-4 text-black dark:text-white">
                        2023 <span className="font-semibold">Marry-Me</span>
                    </p>
                    <div className="border-l border-black dark:border-white  pl-2 ml-2">
                        <p className="text-base leading-4 dark:text-white"> Inc. All rights reserved</p>
                    </div>
                </div>
            </div>
        </div>
